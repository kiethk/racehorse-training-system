                    ...
                    <li key={admission.admissionId}>
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <Pill
                            tone={admission.status === 'APPROVED' ? 'success' : admission.status === 'REJECTED' ? 'danger' : admission.status === 'MANAGER_REVIEW' ? 'warning' : 'info'}
                            size="sm"
                          >
                  ...
                  <div className="p-6 space-y-6 flex-1 bg-[var(--color-surface-subtle)]">
                    ...
                    <Panel padded className="bg-[var(--color-surface)]">
                      ...
                      <div className="mt-4 flex flex-wrap gap-2 text-[12px]">
                        <PipelineStep label="Groom review" isDone={!!detailData.groomReviewedAt} isActive={detailData.status === 'GROOM_REVIEW'} />
                        <PipelineStep label="Stall assignment" isDone={!!detailData.quarantineStallCode} isActive={detailData.status === 'WAITING_FOR_STALL'} />
                        <PipelineStep label="Veterinarian review" isDone={!!detailData.vetReviewedAt} isActive={detailData.status === 'VET_REVIEW'} />
                        <PipelineStep label="Head Trainer review" isDone={!!detailData.trainerReviewedAt} isActive={detailData.status === 'TRAINER_REVIEW'} />
                        <PipelineStep label="Manager final review" isDone={!!detailData.managerReviewedAt} isActive={detailData.status === 'MANAGER_REVIEW'} />
                      </div>
                    </Panel>
